 ...
 * connects their own Dropbox in one click; without it, anybody can set up their own under My
 * account. It shares nobody's files — each person still signs in to their own Dropbox.
 */
    ...
    <section className="import-section account-dropbox" id="dropbox-setup">
      ...
      {dropbox.configured ? (
        <>
          ...
          <details className="advanced" open={expanded}>
